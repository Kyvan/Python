...
class MyWindow(QtWidgets.QWidget):
        ...
        def the_complex_button_was_clicked(self):
                ...
                def pass_phrase(_word1, _word2, _word3, _word4):
                        ...
                        pass9 = f'{_word1.capitalize()}{_word2.capitalize()}{randint(10, 99)}{random.choice(string.punctuation)}{randint(10, 99)}{random.choice(string.punctuation)}{_word4.capitalize()}'
